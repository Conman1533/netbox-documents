...
* Verified for NetBox 4.6.x on netbox-docker 5.0.x (Python 3.14, Django 6.0)
* Replace `drf_extra_fields` dependency with in-plugin base64 file field
* Fix API serializer `validate()` to return parent validation result
* Add multipart/form-data support on document API endpoint
* Fix navigation menu export when `enable_navigation_menu` is False
* Add netbox-docker deployment examples under `deploy/netbox-docker/`
* Add CI workflow testing against NetBox 4.6 in Docker
