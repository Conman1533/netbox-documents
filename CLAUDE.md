...
CI and local integration tests use netbox-docker 5.0.x. See `deploy/netbox-docker/README.md` and `.github/workflows/test.yml`.
...
No runtime dependencies. Base64 file upload is handled by `api/fields.py` (`UploadableBase64FileField`).
